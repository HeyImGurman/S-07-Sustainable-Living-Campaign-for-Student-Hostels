...
export default function Taskbar({ darkMode, setDarkMode }) {
  ...
  return(
    <div className='w-screen font-pliant font-brand'>
      <div className='w-screen h-[3rem] flex justify-left pl-[2rem] items-center bg-red-500 gap-[2rem]'>
        ...
        <button className='ml-auto mr-[2rem] rounded-[5px] pl-[5px] pr-[5px] pt-[5px] pb-[5px] cursor-pointer transition-colors duration-300 ease-in-out hover:bg-red-400' onClick={toggleMode}><CgDarkMode size={20}/></button>
      </div>
    </div>
  );
}
